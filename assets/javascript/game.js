...
function handleGuess(keyName) {
    // Check if guessed before and bail
...
function renderGameState() {
    ...
    document.getElementById("wins").textContent = gameState.wins + " / " + anime.length;
}
...
function checkForGameEnd() {
    ...
    {
        alert("You win!!! It is " + anime[gameState.gameNum].title);
    ...
    {
        alert("You lost, the game was: " + anime[gameState.gameNum].title);
        gameState.gameNum++;
        initializeGame();
    }
...
function getTotalGuessesAllowed(title) {
    ...
    //find num of distinct letters in title
    for (i = 0; i < title.length; i++) {
